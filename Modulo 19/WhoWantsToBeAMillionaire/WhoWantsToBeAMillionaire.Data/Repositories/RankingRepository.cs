...
public class RankingRepository : IRankingRepository
{
    ...
    private const string _querySql = "SELECT ID, PLAYERNAME, HELPCOUNT, SKIPCOUNT, AWARD FROM RANKING";
    private const string _queryInsert = "INSERT INTO RANKING (PLAYERNAME, HELPCOUNT, SKIPCOUNT, AWARD)" +
        "VALUES (@PlayerName, @HelpCount, @SkipCount, @Award)";
